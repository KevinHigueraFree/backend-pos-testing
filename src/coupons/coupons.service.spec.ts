...
describe('CouponsService', () => {
  ...
  describe('update', () => {
    ...
    it('Should return exception because does not found the coupon', async () => {
      ...
      const notFoundException = new NotFoundException(
        `The Coupon with ID: ${couponId} does not found`
      );
  ...
  describe('applyCoupon', () => {
    it('should return message valid coupon', async () => {
      ...
      // Ensure expiration date is always in the future (tomorrow)
      existingCoupon.expirationDate = addDays(new Date(), 1);
    ...
    it('Should return exception because coupon is expired', async () => {
      ...
      // Set expiration date in the past (yesterday)
      expiredCoupon.expirationDate = subDays(new Date(), 1);

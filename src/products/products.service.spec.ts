...
import {
  ...
  getProductsByCategoryWithCategory,
...
describe('ProductsService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw NotFoundException when category does not found', async () => {
      ...
      // Verify complete exception structure
      try {
      ...
      // Verify that product save was not called
  ...
  describe('update', () => {
    ...
    it('should update a product and change its category', async () => {
      ...
      const newCategory = categoriesWithoutProducts.filter(
  ...
  describe('remove', () => {
    it('should remove the product if exists the id', async () => {
      ...
      // Use spyOn to mock the reused findOne method
      const findOneSpy = jest.spyOn(productsService, 'findOne').mockResolvedValue(existingProduct);
      // Mock repository to simulate deletion of found object

...
describe('TransactionsController', () => {
    ...
    describe('findAll', () => {
        ...
        it('should return all transactions when no transactionDate is provided', async () => {
            ...
            // Act
            const result = await transactionsController.findAll(undefined);

            // Assert
            expect(transactionsService.findAll).toHaveBeenCalledWith(undefined);
            expect(result).toEqual(expectedTransactions);
